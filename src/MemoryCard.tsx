  ...
  return (
    ...
    >
      <div
        ...
        style={{ backgroundColor: "rgba(63, 63, 70, 0.25)" }}
      >
        <div
          ref={cardRef}
          className="flex flex-col h-auto px-6 py-6 shadow-lg w-72 rounded-xl bg-amber-50"
        >
          <div className="flex flex-row justify-between text-xl text-zinc-700">
          ...
          <div className="pt-10 text-md text-zinc-700">{memoryText}</div>
        </div>
      </div>
    </div>
  );
